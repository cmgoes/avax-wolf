          ...
          <div className="img-box">
            <div class="img-card">
              ...
              <div style={{width: "132px", height: "132px", background: "rgba(40, 173, 255, 0.1)"}}>
                <img src={wolfPolice} width="100%" alt="" />
              </div>
            </div>
            <div class="img-card">
              ...
              <div style={{width: "132px", height: "132px", background: "rgba(253, 1, 76, 0.1)"}}>
                <img src={wolfThief} width="100%" alt="" />
              </div>
            </div>
          </div>
          <p className="mint-text">CONGRATULATIONS FOR BEING PART OF THE GEN 0 CREW ON POLICE AND THIEF GAME! AFTER ALL THE <span>$LOOT</span> THAT YOU'VE COLLECTED, IT'S TIME TO ADD TO THE CREW WITH THIS LATEST PROFILE PICTURE COLLECTION.</p>
          <div className="road-panel">
            ...
            <div className="Minting-progressBarBox">
              <div className="Minting-progressBar" style={{height: "100%", width: "0%"}}>
                <img src={wolfPolice} class="Minting-car" alt="" style={{left: "calc(0% - 0px)", bottom: "-3px"}} />
              </div>              
            </div>
          </div>
          <div class="Minting-amount">0/10000 MINTED</div>
          <div class="Minting-balance">You have no unclaimed balance</div>
